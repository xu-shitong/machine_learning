...
% ----------------------------------------------------------------------
% |            A Gental Introduction to Graph Neural Network           |
% ----------------------------------------------------------------------
...
模型：
  ...
  \quad \quad \quad 1. 对每一节点，求相邻edge向量和。经过全连接层转为$\mathbb{R}^{h_v}$向量

  \quad \quad \quad 2. 1.中结果和此节点原向量相加，做mlp输入
  ...
  \quad \quad \quad 1. 每一节点/边向量求和，经过全连接层转为$\mathbb{R}^{h_g}$向量

  \quad \quad \quad 2. 和$g$相加，做mlp输入 
